...
export interface ApiInformationPageInformationPage
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    staticInformation: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiStaticInformationStaticInformation
  ...
  info: {
    displayName: 'StaticInformation';
    pluralName: 'static-informations';
    singularName: 'static-information';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    color: Schema.Attribute.Component<'color-picker.color-picker', false> &
      Schema.Attribute.Required;
    content: Schema.Attribute.DynamicZone<
      [
        'content.text',
